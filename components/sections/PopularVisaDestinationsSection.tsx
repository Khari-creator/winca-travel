...
import { CalendarDays, Globe, Mail, Phone, Send, User } from 'lucide-react'
...
const visaDestinationCards = [
  {
    name: 'United Kingdom',
    slug: 'uk',
    description: 'Tourist, business & student visas with guided application support.',
    image: '/visas/uk.jpg',
  ...
  },
  {
    ...
    slug: 'schengen',
    description: 'Travel across multiple European countries with a single visa.',
  ...
  },
  {
    name: 'United States',
    slug: 'usa',
    description: 'Professional assistance for B1/B2, student & work visas.',
    image: '/visas/usa.jpg',
  ...
  },
  {
    name: 'Dubai (UAE)',
    slug: 'dubai',
    description: 'Fast tourist & business visa processing for Dubai travel.',
  ...
  },
  {
    name: 'Canada',
    slug: 'canada',
    description: 'Visitor, student & work visa application support.',
  ...
  },
  {
    name: 'Australia',
    slug: 'australia',
    description: 'Guided applications for tourism, study & skilled visas.',
...
const visaTypes = ['Tourist Visa', 'Business Visa', 'Transit Visa', 'Conference Visa', 'Student Visa', 'Work Visa']

const formInputClassName =
  'w-full rounded-xl border border-gray-200 px-4 py-3 outline-none transition focus:border-red-600 focus:ring-3 focus:ring-red-600/15'
    ...
    <section className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-secondary font-semibold text-sm uppercase tracking-wide">Visa Destinations</span>
          <h2 className="text-3xl md:text-4xl font-bold text-primary mt-3 mb-4">Popular Visa Destinations</h2>
          <p className="text-gray-600">
            We assist travelers with visa applications for the world&apos;s most visited destinations, ensuring a smooth
          ...
          {visaDestinationCards.map((item, index) => (
            ...
            >
              <div className="relative h-52">
                ...
                />
                <h3 className="absolute bottom-4 left-4 text-white text-xl font-bold drop-shadow-md">{item.name}</h3>
              </div>

              <div className="p-6 flex flex-col">
                <p className="text-sm text-gray-600 mb-6 grow">{item.description}</p>
...
function VisaInquiryForm() {
  ...
  const { status, message, isSubmitting, submitInquiry } = useInquirySubmission(
    'Your visa request has been emailed to our consultants.'
  )
    ...
    <section className="relative mt-32">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-16 text-white">
          ...
          <h3 className="text-3xl md:text-4xl font-bold mb-4">Start Your Visa Application</h3>
          <p className="max-w-2xl mx-auto text-white/80">
            Submit your travel details and our visa consultants will guide you step by step through the application
            process.
          </p>
        </div>
        ...
        >
          ...
          <div className="md:col-span-2 mt-8 text-center">
            <button
              type="submit"
              disabled={isSubmitting}
              className="inline-flex items-center gap-3 bg-linear-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 disabled:cursor-not-allowed disabled:opacity-70 text-white px-14 py-4 rounded-xl font-semibold shadow-xl transition"
            >
              {isSubmitting ? 'Sending...' : 'Submit Visa Request'}
              <Send size={18} />
            </button>

            <p className="mt-4 text-sm text-gray-500">We&apos;ll contact you within one business day.</p>
            <InquiryFeedback status={status} message={message} className="mt-4 text-left" />
          </div>
        </form>
      </div>
    </section>
